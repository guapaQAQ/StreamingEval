...
#                            level=getattr(logging, args.log_level))
    ...
    def output_transcript(o, unaware_now=None, aware_now=None):
        ...
        if o[0] is not None:
            if aware_now is not None:
                print("%1.4f %1.4f %1.0f %1.0f %s" % (unaware_now*1000, aware_now*1000, o[0]*1000,o[1]*1000,o[2]),file=logfile,flush=True)
                print("%1.4f %1.4f %1.0f %1.0f %s" % (unaware_now*1000, aware_now*1000, o[0]*1000,o[1]*1000,o[2]),flush=True)
            elif unaware_now is not None:
                now = time.time()-start
                print("%1.4f %1.4f %1.0f %1.0f %s" % (unaware_now*1000, now*1000, o[0]*1000,o[1]*1000,o[2]),file=logfile,flush=True)
                print("%1.4f %1.4f %1.0f %1.0f %s" % (unaware_now*1000, now*1000, o[0]*1000,o[1]*1000,o[2]),flush=True)
            else:
                now = time.time()-start
    ...
    if args.offline: ## offline mode processing (for testing/debugging)
        ...
        while True:
            ...
            try:
                ...
                now = time.time()
                output_transcript(o, unaware_now=end, aware_now=end+now-before_process)
        ...
        while True:
            ...
            try:
                ...
                output_transcript(o, unaware_now=end)
            now = time.time() - start
    ...
    o = online.finish()
    output_transcript(o, unaware_now=duration, aware_now=duration+time.time()-before_finish)